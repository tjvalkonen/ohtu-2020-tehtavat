...
public class KassapaateTest {
    ...
    @Test
    public void lataaMaksukortilleRahaaJosSummaOnPositiivinen() {
        kassa.lataa(kortti, 120);

        verify(kortti).lataa(eq(120));
    }

    @Test
    public void eiTeeMaksukortilleMitaanJosSummaOnNegatiivinen() {
        kassa.lataa(kortti, -120);
